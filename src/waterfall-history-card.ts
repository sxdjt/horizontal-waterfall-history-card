...
export class WaterfallHistoryCard extends LitElement {
  ...
  public static getStubConfig(hass?: any): Partial<WaterfallHistoryCardConfig> {
  ...
  private _syncInlineColumnWidths(): void {
  ...
  private _syncColumnWidth(selector: string): void {
    const els = this.shadowRoot?.querySelectorAll<HTMLElement>(selector);
...
console.info(
  `%c WATERFALL-HISTORY-CARD %c v4.8.0 `,

    ...
    `;return _?F`
        <div class="entity-inline-container" @click=${t=>this._handleEntityClick(i,t)}>
          ...
          <div class="entity-inline-graph">
            ...
            ${c?F`
              <div class="labels">
                <span>${p}${this.t("hours_ago")}</span>
                <span>${this.t("now")}</span>
              </div>
            `:""}
          </div>
          ${u?F`<div class="entity-inline-value">${this.displayState(f,e)}</div>`:""}
        </div>
        ${d?F`
          <div class="min-max-label">
            ${this.t("min_label")}: ${this.displayState(l,e)} / ${this.t("max_label")}: ${this.displayState(h,e)}
          </div>
        `:""}
      `:F`
      <div class="entity-container" @click=${t=>this._handleEntityClick(i,t)}>
        <div class="entity-header">
          ${a?F`<ha-icon class="entity-icon" .icon=${o}></ha-icon>`:""}
          <span class="entity-name">${n}</span>
          ${u?F`<span class="current-value">${this.displayState(f,e)}</span>`:""}
        </div>
        <div class="waterfall-container">
          ${y}
        </div>
    ...
    `:F``}_renderBasicSettings(){return F`
      <div class="section">
        ...
        <ha-textfield
          ...
          min="24"
          max="96"
          .value=${this._config.intervals||bt}
